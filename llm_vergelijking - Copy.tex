...
\chapter{\IfLanguageName{dutch}{Vergelijking resultaten LLMs}{Vergelijking resultaten LLMs}}%
...
\section{Vergelijking van de parse-resultaten met OpenAI en met Anthropic}
\begin{table}[h!]
