...
\begin{listing}[h!]
    ...
    <h3 style="font-weight:normal;margin:0;font-size:17px;line-height:20px;">
     ...
     S0191886925001308" class="gse_alrt_title" style="fon...ine-height:22px">
...
Daarnaast zijn tot zover beide oplossingen ook afhankelijk van een online third-party service wat niet overeenkomt met de doelstellingen.
...
Tenslotte moet ook nog SerpAPI \autocite{Serpapi2025} vermeld worden. SerpAPI laat toe om data te scrapen voor elke mogelijke search engine, waaronder ook GS. Alleen focust hun product telkens op de online search engine en niet op alerts waardoor de zoekresultaten niet incrementeel zijn. Dat voldoet niet aan de doelstellingen.\\
