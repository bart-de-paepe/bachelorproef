...
De code op github \textcite{DepaepeBeautifulsoup2025} maakt hiervan een implementatie aangepast voor de Google Scholar alerts. 
...
\begin{listing}
    ...
    \label{code:Soupnav}
\end{listing}
De volledige uitwerking is te zien in bijlage Parse Google Scholar zoekopdracht.\\
