...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{./5_semantic_search/chroma-cosine-score.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{./5_semantic_search/mongodb-cosine-score.jpg}
