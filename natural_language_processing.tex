...
\end{figure}
De Tf-Idf methode is de de facto berekening van de relevantie van een term voor een bepaalde tekst. De ``TFidVectorizer()'' \autocite{TfidfVectorizer2025} van Scikit-Learn is een praktische tool om de Tf-Idf score van elk afzonderlijk woord in een tekst te berekenen. De code op github \textcite{Depaepenlp2025} maakt hiervan een implementatie aangepast voor de GS alerts.
...
Coreference resolution vervangt de voornaamwoorden in de tekst door het trefwoord waarnaar ze verwijzen (vb. tabel \ref{table:nlp}).
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|} 
        \hline
