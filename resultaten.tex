...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{8cm}|p{5cm}|}
        ...
        \hline
        \begin{tabular}{@{}p{7.0cm}@{}} % slight padding to avoid touching border
            \hspace{0.5cm}Percentage aantal keer dat de DOI in de URL staat. \\
            \hspace{0.5cm}Percentage aantal keer dat de DOI via Crossref gevonden wordt. \\
            \hspace{0.5cm}Percentage aantal keer dat de DOI op de webpagina staat.
        \end{tabular}
        &
