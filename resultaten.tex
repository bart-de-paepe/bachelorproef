...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|p{2cm}|X|} 
        \hline
        \rowcolor{lightgray}
        \multicolumn{2}{|X|}{\textbf{Is de tool een verbetering ten opzichte van de manuele verwerking van de GS alerts?}} \\
        \hline
        ...
        \hline
        \rowcolor{lightgray}
        \multicolumn{2}{|X|}{\textbf{Gaan de publicaties uit de GS alerts nu sneller verwerkt worden dankzij de tool?}} \\
        \hline
