...
Er werd aan 5 gebruikers van de tool gevraagd om 2 vragen te beantwoorden:
\begin{itemize}
...
\end{itemize}
2 gebruikers deelden hun feedback zoals te zien is in tabel \ref{table:gebruikersfeedback}.
\begin{table}[h!]
